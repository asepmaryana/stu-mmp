<?php
class AvailabilityMonthlyModel extends CI_Model 
{
	// table name
	public $table	= 'pms.availability_monthly';
	...
	function getCount($m, $y, $region)
	{
        ...
        $sql   .= "and node_id in (select id from pms.node_view where region_id = '$region')";
	...
	// get availability_monthly by id
	...
	// add new availability_monthly
	function save($data)
	{
		return $this->db->insert($this->table, $data);		
	}
	
	// update availability_monthly by id
	...
	// delete availability_monthly by id
	function delete($id)
	{
		$this->db->where('id', $id);
    ...
    function get_rect_av_mon_region($hosts, $month, $year)
    {
